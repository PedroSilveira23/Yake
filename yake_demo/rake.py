...
class Rake(object):
    def __init__(self, lan, min_char_length=1, max_words_length=25, min_keyword_frequency=1):
        self.__lan = lan
        self.__stop_words_pattern = build_stop_word_regex(lan)
